...
class UserList extends Component {
    ...
    lastPage = () => {
        if(this.state.currentPage < Math.ceil(this.props.userData.users.length / this.state.usersPerPage)) {
            this.setState({
                currentPage: Math.ceil(this.props.userData.users.length / this.state.usersPerPage)
            });
        }
    };
                            ...
                            <Card.Footer>
                                ...
                                <div style={{"float": "right"}}>
                                    <InputGroup size="sm">
                                        ...
                                        <FormControl className={"page-num bg-dark"} name="currentPage"
                                                     value={currentPage}
...
export default connect(mapToStateProps, mapDispatchToProps)(UserList)
